class ComplexNumber:
    ...
    def __sub__(self, other):
        real = self.real_part - other.real_part
        im = self.im_part - other.im_part
        return ComplexNumber(real, im)

    def __truediv__(self, other):
        recipr_real = other.real_part / (other.real_part ** 2 + other.im_part ** 2)
        recipr_im = -1 * other.im_part / (other.real_part ** 2 + other.im_part ** 2)
        return self * ComplexNumber(recipr_real, recipr_im)